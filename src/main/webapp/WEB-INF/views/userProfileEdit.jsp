...
<rapid:override name="main"><%--@elvariable id="euser" type="org.wtiger.inno.litportal.models.pojo.UserPojo"--%>
    <div class="main">
        <div><h2>Редактирование профиля</h2></div>
        <form action="./editUserProfile" method="post" class="form-signin center-pill registration-table">
            ...
            <label for="role" class="">Роль</label>
            <input id="role" class="form-control" type="text" name="role" value="${euser.role}" required>
            ...
            <input id="visibleName" class="form-control" type="text" name="visibleName" value="${euser.visibleName}"
                   required>
            <label for="enabled" class="">Активен</label>
            <input id="enabled" class="form-control" type="checkbox" name="enabled"
                   <c:if test="${euser.enabled==true}">checked</c:if>>
